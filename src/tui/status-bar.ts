...
// Re-exported so existing callers that imported these from the status bar keep
// working; the implementations now live in the UI-neutral `format` module.
export { formatCompactNumber, formatElapsed } from "../format.js";
