...
| [0015](./0015-context-estimation-tokens-only.md) | Context estimation is tokens-only (candidate 3) | `—` | Report premise stale; removed unused `chars` fields from 3 summary helpers, kept `estimateMessageChars` as the `chars/4` basis |
